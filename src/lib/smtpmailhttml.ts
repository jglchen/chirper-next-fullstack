import { ResetPasswordHTMLType, VerifyEmailHTMLType, ChirpCreatedNotifyHTMLType } from '@/lib/types';
...
export function chirpCreatedNotifyHTML({host, senderName, message}: ChirpCreatedNotifyHTMLType): string{
    const htmlStr =  
    `
    <html>
    <body style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';">
    ...
    Regards.
    <br/>
    Next.js Laravel Chirper
    </div>
    <div>
    <hr />
    </div>
    <div style="margin-top: 1rem;margin-bottom: 1rem;font-size: 1rem;line-height: 1.5rem;color: #4B5563;overflow-wrap: break-word;">
    If you are having trouble clicking the &quot;Go to Chirper&ldquo; button, copy and paste the URL below into your web browser: <a style="color: #2563EB;text-decoration: underline;" href='${host}/'>${host}/</a>
    </div>
    </div>
    </div>
    </body>
